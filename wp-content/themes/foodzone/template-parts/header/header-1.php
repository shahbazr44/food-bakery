            ...
            <nav class="sb-menu separate-line submenu-top-border submenu-scale">
                <ul>
                    ...
                    <li class="right-space dropdown_menu">
                        <div class="dropdown">
                            <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-expanded="false"> <i class="fa fa-dot-circle-o" aria-hidden="true"></i><?php echo esc_html__('Choose Location', 'foodzone') ?> </button>
                    ...
                    <li class="color-x"> <a href="#" class="btn btn-theme"><i class="fa fa-cutlery" aria-hidden="true"></i><?php echo esc_html__('Restaurant Register', 'foodzone') ?></a> </li>
                </ul>
            </nav>
        </div>
    </div>
